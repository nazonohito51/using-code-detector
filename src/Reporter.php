...
use PHP_CodeCoverage_Report_HTML_Renderer_Dashboard;
use PHP_CodeCoverage_Report_HTML_Renderer_Directory;
use PHP_CodeCoverage_Report_HTML_Renderer_File;
use PHP_CodeCoverage_Report_Node_Directory;

/**
 * This is copy of PHP_CodeCoverage_Report_HTML...
 */
class Reporter
{
    /**
